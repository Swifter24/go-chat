...
func LoadConfig() error {
	if _, err := toml.DecodeFile("C:\\Users\\Administrator\\Desktop\\go_chat\\configs\\config.toml", config); err != nil {
		log.Fatal(err.Error())
		return err
	}

	//// Ubuntu22.04云服务器部署
	//if _, err := toml.DecodeFile("/root/project/go_chat/configs/config.toml", config); err != nil {
	//	log.Fatal(err.Error())
	//	return err
	//}
